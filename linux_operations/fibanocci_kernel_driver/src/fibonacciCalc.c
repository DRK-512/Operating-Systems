 ...
 * mpz > mprf because mprf is for floating point, mpz is easier to use for this
 * application
 */

// Here I calculate the n-th Fibonacci number
void fibonacciCalcLow(unsigned long long *result, unsigned int n) {
        // 94 -> 19740274219868223167 > 18446744073709551615 unsigned long long
        // max
        if (n <= 1 || n > 93) {
...
// I could use mpz_sizeinbase, but fib(130) should be 27 # long, but it returns
// 28, so I want more accurate numbers
