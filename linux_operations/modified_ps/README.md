# Mod-ps
The purpose of this project is to read data from a process and show it to the user in a more readable manner than ps -aux
This was a colaborative project with my friend Tejas Bolar to the formating may not match the rest of my projects
...
The program will implement the features triggered by the following options. If no options are
...
All of the output must match with the output of “ps --ely” for the same pid.
