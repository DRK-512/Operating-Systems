...
/*
 * Brief description of the task: This will show the options if the user types
 * in an incorrect argument
 */
void show_options() {
        printf("Invalid Input\n");
        printf("Options for this program: \n");
        printf("-p <pid> : Returned info is about this pid. If option is not "
               "used, "
               "process 1 is used\n");
        printf("-s       : Returns the state of the given pid\n");
        printf("-t       : Returns amount of time consumed by this process in "
               "hours:min:seconds format\n");
        printf("-v       : Returns the amount of virtual memory currently "
               "being used "
               "by this program\n");
...
void print_values(options opts) {
        ...
        if (checkFile(opts.pid)) {
                /* Stat files have a most of the information we need for this
                 * project */
